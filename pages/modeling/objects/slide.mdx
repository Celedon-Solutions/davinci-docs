---
title: Slides
icon: /images/objecticons/slide.svg
---
...
### Figure Elements
Figure elements render live model diagrams. An element can reference a reusable [Figure object](/pages/modeling/objects/figure), which owns its roots, render mode, layout, and styling, or directly reference another model object for a simple visualization stored on that slide.

Reusable Figure objects are useful when the same diagram appears in multiple slides or documents, or when it needs custom styling, multiple roots, and manual layout overrides.
...
**No.** Slides do not currently support [object inheritance](/pages/modeling/common/inheritance).
</ParamField>
...
<ParamField path="Attributes" type="object">
  Attributes owned by the presentation for reusable parameters, metadata, and equations associated with the artifact.
