...
<div style={{ display: 'flex', flexDirection: 'row', gap: '10px' }}>
  <img height="20" noZoom src="/images/objecticons/requirement.svg" />
  <a href="/pages/modeling/objects/port" style={{ borderBottom: 'none' }}> <img height="20" noZoom src="/images/objecticons/code.svg" /> </a>
</div> 
  ...
  [Read more about Code](/pages/modeling/common/code)
