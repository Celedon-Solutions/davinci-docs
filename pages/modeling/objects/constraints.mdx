---
title: Constraints
icon: /images/objecticons/constraint.svg
---
...
<Info>Unit conversions use the same unit system as attributes. See [Unit Settings](/pages/editor/project-settings/unit-settings) for custom unit definitions.</Info>
...
**Yes.** Constraints can be used as bases or specializations through [object inheritance](/pages/modeling/common/inheritance).
</ParamField>
