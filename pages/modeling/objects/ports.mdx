...
Nesting a port can be used to model a connector housing with the children ports as the specific pinouts. At this time only one level of nesting is supported in the block render view.
