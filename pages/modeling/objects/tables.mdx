---
title: Tables
icon: /images/objecticons/table.svg
---
...
When importing a large workbook, Davinci may ask how you want to handle the file:

- Import as editable Davinci tables when you want spreadsheet cells, formulas, and formatting converted into model objects.
- Import as a CSV-backed reference when the workbook is mainly source data and does not need full spreadsheet editing.
- Upload the raw XLSX file when you want to preserve the original workbook as source material.

This helps keep very large workbooks usable without forcing every cell into the model.
...
**No.** Tables do not currently support [object inheritance](/pages/modeling/common/inheritance).
</ParamField>
...
<ParamField path="Attributes" type="object">
  Attributes owned by the table for reusable parameters, metadata, and equations associated with the artifact.
