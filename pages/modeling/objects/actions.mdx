...
## Activity View
The Activity View visually represents the sequence and flow of actions, showing control nodes, decision points, and parallel execution paths.

## Sequence View
The Sequence View illustrates interactions between the action and other system components over time, detailing the message exchange order.
