---
title: Interfaces
icon: /images/objecticons/interface.svg
---
...
**Yes.** Interfaces can be used as bases or specializations through [object inheritance](/pages/modeling/common/inheritance).
</ParamField>
