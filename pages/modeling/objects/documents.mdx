---
title: Documents
icon: /images/objecticons/document.svg
---
...
### Figure Blocks
Figure blocks render live model diagrams. A block can reference a reusable [Figure object](/pages/modeling/objects/figure), which owns its roots, render mode, layout, and styling, or directly reference another model object for a simple local visualization. Figure captions are separate caption blocks and can provide automatic numbering and cross-references.
...
- **Figure**: Insert a reusable Figure object or a direct visualization of another model object
...
**No.** Documents do not currently support [object inheritance](/pages/modeling/common/inheritance).
</ParamField>
...
<ParamField path="Attributes" type="object">
  Attributes owned by the document for report parameters, metadata, and equations that belong to the artifact.
