---
title: Item
icon: /images/objecticons/item.svg
---
...
| [Block](/pages/user-guide/views/block) | Visual block diagram showing item composition. |
| [History](/pages/editor/model-area) | Track changes of attributes. |

## Properties Fields

<ParamField path="Inheritable" type="boolean">
**Yes.** Items can be used as bases or specializations through [object inheritance](/pages/modeling/common/inheritance).
</ParamField>
