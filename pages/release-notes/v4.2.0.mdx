...
- Search from the top bar for finding projects and users
...
- Improved authentication with SSO improvements and rate limiting
- Enhanced admin panel for user, project, and billing management
- Git service optimizations including lazy-loaded recent activity
- Notification delivery system with actionable notifications and admin broadcasts
