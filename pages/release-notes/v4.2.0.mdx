...
- New [Home](/pages/browser/home) page with a sidebar project list, resume cards, and an activity feed
...
- Redesigned [Account Settings](/pages/browser/account) with tabs for General, Billing, Connections, Storage, and About
- [Notifications](/pages/browser/notifications) system with a top-bar dropdown and a full notifications page
- [User Profiles](/pages/browser/profile) showing public projects and recent activity
...
- Create a [team](/pages/browser/teams) with a name and billing frequency, then invite members by email
...
- [Upgrade page](/pages/browser/change-plan) for switching between Free, Core, and Max without leaving Davinci
...
- New [projects](/pages/browser/projects) can be set as Private or Public at creation time
- Improved project import with better UUID, [reference](/pages/editor/files-and-references), and error handling
- Import button disabled when project count exceeds plan limits
- Better error feedback when inviting [collaborators](/pages/editor/collaboration/overview)
...
- [Action](/pages/modeling/objects/actions) runtime management with duration tracking and retry signals
- Async support in action sequences with awaitable expressions
- Implicit conditional fallthrough handling
- [State machine](/pages/modeling/objects/states) smoke testing tool
