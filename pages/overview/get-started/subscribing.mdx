...
<Note>
  Users from organizations with private or local deployments should contact their system adminsitrator for access
</Note>
...
<Steps>
    ...
    <Step title="Begin Using Davinci">
      You can now begin using Davinci for free! To gain access to premium AI models or purchase more credits, please subscribe to Davinci Core or Davinci Max via the `Upgrade` button in the application header.
    </Step>
