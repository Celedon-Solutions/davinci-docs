...
title: Model Area
---
The Model Area is the primary workspace inside the [Editor](/pages/editor/interface). It is where all model interaction happens — browsing objects, viewing and editing elements, and interacting with the design agent. The Model Area is displayed automatically when you open a project.
...
<img width="50" noZoom src="/images/s-h-index.png" />
...
<img width="50" noZoom src="/images/s-h-panel.png" />
...
<Card title="Right Panel" horizontal icon="link" href="/pages/editor/right-panel/overview" >
