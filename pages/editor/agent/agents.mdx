...
For detailed information about the agent chat interface and input options, see the [Agent Chat documentation](/pages/editor/right-panel/agent-chat).
...
[Skills](/pages/editor/agent/skills) are reusable project guidance for specific kinds of agent work. Use them to define research methods, workflow rules, generation patterns, naming conventions, or review checklists that should apply across repeated tasks.
...
Break complex tasks into smaller steps. Review each step before proceeding to the next, using [Planning](/pages/editor/agent/planning), checkpoints, and [Version Control](/pages/editor/right-panel/version-control) to save progress along the way.
