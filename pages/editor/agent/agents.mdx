...
For detailed information about the agent chat interface and input options, see the [Davinci Agent documentation](/pages/editor/widgets/agent-chat).
...
[Read more about uploading files to Davinci](/pages/editor/project-settings/files#uploading-files)
...
Personas can be created and managed in [Project Settings](/pages/editor/project-settings/persona-settings).

### Skills

[Skills](/pages/editor/widgets/skills-rules) are reusable project guidance for specific kinds of agent work. Use them to define research methods, workflow rules, generation patterns, naming conventions, or review checklists that should apply across repeated tasks.

### Planning

For complex work, the agent can create an editable [plan](/pages/editor/agent/planning) with tasks, dependencies, and clarification points. Review the plan before running it when the task affects important model structure or requires several steps.
...
Break complex tasks into smaller steps. Review each step before proceeding to the next, using [Planning](/pages/editor/agent/planning), checkpoints, and [Source Control](/pages/editor/widgets/source-control) to save progress along the way.
