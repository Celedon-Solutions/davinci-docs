...
<Info>
Davinci also includes structured [Planning](/pages/editor/agent/planning), [Skills](/pages/editor/agent/skills), and [Model Review](/pages/editor/agent/model-review) workflows for guiding how the agent plans, executes, and inspects engineering work.
</Info>
...
<Note>
[Skills](/pages/editor/agent/skills) guide how the agent uses available tools. They do not add new tools by themselves.
</Note>
