...
[Workflow skills](/pages/editor/widgets/skills-rules) can guide how plans are created and executed. For example, a workflow skill can require source inspection before extraction, require review tasks after generation, or define a standard review process.
