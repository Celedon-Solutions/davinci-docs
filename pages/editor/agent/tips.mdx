...
For recurring methods or constraints, capture the guidance as a [Skill](/pages/editor/widgets/skills-rules) so the agent can reuse it across tasks.
...
For larger tasks, ask the agent to create a [plan](/pages/editor/agent/planning) first. Review the plan, edit task order or dependencies if needed, then run it when the scope looks right.
