...
Search is a more powerful version of the Search Bar in the Header. Header Search only allows searching by Object Name or Short Name. Search also checks data fields, documentation, relationships, uses, tags, and more.
...
Search has two optional settings for refining your search:
...
Search can also show all Model Objects that have a certain Tag.
