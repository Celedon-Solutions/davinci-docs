...
The Validation Panel allows users to see where Errors and incomplete objects may exist within the Model in one central location. 
...
Each result shown in the Validation Panel will be a "Root Cause", meaning the error or TBD originates from that Object. 
