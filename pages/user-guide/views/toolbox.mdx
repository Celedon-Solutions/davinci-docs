---
title: Toolbox View
icon: /images/toolbox-icon.png
---

<img width="50" noZoom src="/images/toolbox-icon.png" />
...
Toolbox objects support exporting in formats suitable for sharing and integration.

| Format | Description |
|--------|-------------|
| PY | Export toolbox code as a Python file for use in external environments |
| MCP | Export toolbox in Model Context Protocol format for integration with MCP-compatible systems |

These export options enable toolbox reuse across projects and integration with external tools.
