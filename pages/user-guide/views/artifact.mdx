---
title: Artifact View
icon: /images/artifact-icon.png
---

<img width="50" noZoom src="/images/artifact-icon.png" />
...
## Table
Table cells can be either text, equations or a reference to an object. Text cells can have paragraphs or lists (bulleted or numbered) and include all the same text editing features as a document block.
...
Export options vary depending on the artifact type being viewed:

### Document Export

| Format | Description |
|--------|-------------|
| PDF | Export document as a formatted PDF preserving layout, fonts, and styling |
| DOCX | Export document as Microsoft Word format for further editing |

### Table Export

| Format | Description |
|--------|-------------|
| XLSX | Export table data as Excel spreadsheet with formulas and formatting preserved |

### Matrix Export

| Format | Description |
|--------|-------------|
| XLSX | Export matrix data as Excel spreadsheet with all rows and columns |
