...
<Frame>
    <img height="400" noZoom src="/images/agent_workspace_overview.png" />  
</Frame>
...
Click the **globe icon** to enable web search for the agent. When enabled, the agent can:
...
<Frame>
    <img noZoom src="/images/agent_undo_action.png" />
</Frame>
