...
### Owned
 Projects in the Owned list were created and are Owned by you. These Projects contribute to your overall Storage usage and can be renamed and deleted at any time.

### Shared
Shared Projects are Owned by another Davinci User that you are a Collaborator on. These Projects do not contribute to your Storage usage and cannot be permanantely deleted by you.
...
### Delete a Project
1. Mouse over the project to delete
2. Click the trashcan button on the far right of the project
3. Confirm the deletion in the popup.

<Note>Only projects in the Owned list can be deleted</Note>
