...
<Frame>
  <img height="400" noZoom src="/images/home-with-projects.png" /> 
</Frame>
...
<Frame>
  <img height="400" src="/images/workspace-overview.png" /> 
</Frame>
...
<Frame>
  <img height="400" noZoom src="/images/project-rename.png" /> 
</Frame>
...
### Search Bar
At the top of the window is a search box. Clicking on this will open up a search menu. Begin typing to search the Model for Model Objects. Clicking on search results will open them up in the main tab. The Search Bar will only search for objects by Name or Short Name. For more refined search querries, use the [Search View](/pages/user-guide/right-panel/search-view)
