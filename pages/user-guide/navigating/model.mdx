...
title: Model Area
---
The Model Area is the primary workspace inside the [Editor](/pages/user-guide/navigating/editor). It is where all model interaction happens — browsing objects, viewing and editing elements, and interacting with the design agent. The Model Area is displayed automatically when you open a project.
