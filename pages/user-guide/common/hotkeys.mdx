...
| key             | Name        | Impact                                                                                    |
| --------------- | -----       | ----------------------------------------------------------------------------------------- |
| `CTRL+A`      | Select All  | Select all text within the current Focus Area. Use in combination with CTRL+C to copy.                                                                         |
...
<Note>Mac users should use Command (⌘) instead of Control (CTRL)</Note>
