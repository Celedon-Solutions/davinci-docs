...
Project-wide tag management is handled in [Project Settings](/pages/user-guide/project-settings/project). Here you can view all tags, manage their assignments, and configure their properties.

<Frame>
    <img noZoom src="/images/tags-settings.png" />
</Frame>
...
<Frame>
    <img noZoom src="/images/tag-edit-settings.png" />
</Frame>
