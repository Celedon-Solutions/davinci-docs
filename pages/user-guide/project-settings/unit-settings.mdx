...
The Unit Settings view allows you to define custom units for use in your project. These units can be used in attribute definitions, equations, and code throughout the model.
