...
## Description
Objects in the model have defined relationships with each other that establish an explicit knowledge graph of the system being modeled. These relationships are bi-directional and can be traversed by the user while exploring the model. A summary of the existing relationships in Davinci are dicussed below: 
