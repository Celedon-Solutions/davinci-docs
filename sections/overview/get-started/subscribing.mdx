...
Go to the [Davinci Beta subscription page](https://davinci.celedon.solutions).

Option 1. **Sign-In Using Google**
   - Click the sign in with google button
   - Select your google account to sign in with
   - Upon sign-in, you will automatically be directed to Davinci
...
Option 2. **Sign-In Using Email**
   ...
   - Once your email is verified, you will be directed to Davinci
