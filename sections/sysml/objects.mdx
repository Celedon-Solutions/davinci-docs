...
| -----------------------------------------------------  | ------------------------------------- | ----- |
| . ![](/images/objecticons/package.svg) /> | Container to organize model elements in. |Y|
| <img src="/images/objecticons/part.svg#svgView(viewBox(0,0,100,100))" />    | Primary model structural elements.       | Y |
