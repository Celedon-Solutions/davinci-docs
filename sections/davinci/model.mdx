...
## Event Log
The event log is where the user can see all of the prior updates, manual or AI, that occur in the model. Each event provides a summary of the changes. To view the details simply click on that event log. Any undo/redo actions will be indicated by the white dot.

In addition, for actions performed by Davinci, the compute cost is shown in this log.
