...
## Reloading Projects
In the event that a project needs to be reloaded from the project server, use the sync icon when hovering over the project in the list to reload and sync your project data.