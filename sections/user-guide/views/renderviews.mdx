...
For attributes, this tree does not represent owned attributes but rather the referenced values used in equations. It visualizes the roll-up tree that determines the attribute values.
