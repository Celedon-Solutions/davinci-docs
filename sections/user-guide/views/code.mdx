...
<img height="400" noZoom src="/images/workspace_example_code_aiEdit.jpg" /> 

Normally the edits will consider the code selected and its content in the object. To consider other reference information you can add reference objects using the add reference button to the right of the input box.

While the range of selection will be the focus, Davinci can edit any code in the object based on the instruction.
