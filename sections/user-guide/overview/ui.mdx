...
n the bottom of the side panel is the download button which allows you to export the render or data of the view. 
...
## Project 
The project view is accessed from the left most pane in the window. In this view you can see the project summary, see collaborators, review snapshots, update custom units, or remove files stored in your project. 
