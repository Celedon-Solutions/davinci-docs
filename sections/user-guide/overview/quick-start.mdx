...
## Review the Result 
On task compelete you will see new objects populated in the mode index pane (on the left side of the window). You can either interact directly clicking on objects in the index or you can click on the `View` button in the chat response to see a change log of the AI modifications. 
