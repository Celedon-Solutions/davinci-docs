...
## Create a Project
From the home page click on the green new project button. This will focus you into naming a new project inside your existing projects list. Once named, the project will get a uuid. Once that uuid is ready you can click on that element to load in the project. 
