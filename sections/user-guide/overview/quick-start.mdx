...
## Login
Access davinci at [Davinci](https://davinci-app.com/app) and either create or login with your account.
...
<img height="400" src="/images/home_project_def.jpg" /> 
 ...
 Once named, the project will get asssigned an id. Once that id is ready you can click on that element to load in the project. 
...
## Review the Result 
On task compelete you will see new objects populated in the mode index pane (on the left side of the window). You can either interact directly by clicking on objects in the index or you can click on the `View` button in the chat response to see a change log of the AI modifications. 
