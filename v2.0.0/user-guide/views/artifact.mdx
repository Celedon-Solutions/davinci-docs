...
<img height="400" noZoom src="/images/workspace_example_document.jpg" /> 
...
### Davinci Editing
You can use Davinci to make inline edits by selecting a range of text. Once selected a popup will appear and selecting the edit icon will make a input window open to allow instructions to edit specific areas of the document.

<img height="400" noZoom src="/images/workspace_example_document_aiEdit.jpg" /> 

Normally the edits will consider the block selected. To consider other reference information you can add reference objects using the add reference button to the right of the input box. 

<Note>The changes made will replace any selected blocks with new updated blocks. Edits only occurs as replacements to the range of blocks selected.</Note>
...
<img height="400" noZoom src="/images/workspace_example_table.jpg" /> 
