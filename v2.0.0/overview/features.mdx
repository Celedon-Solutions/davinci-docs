...
- **Matricies**: N^2 display of relationships between model objects.
...
- **Artifact Generation**: Create text, tables, figures, and matricies from model data automatically.
...
- **Data Export**: Export data in various formats (.sysml, .docx, .xlsx, .png).
