---
title: "Make a Systems Model from an OV-1 in 10 Minutes with Davinci"
description: "Rapidly transform DODAF OV-1 diagrams into structured systems models using Davinci"
...
### What is the OV-1 (Operational View - High Level Operational Concept Graphic)?

The **OV-1** is one of the most fundamental and widely-used DODAF products. It provides a high-level graphical/textual description of the operational concept, showing:
...
**User uploads OV-1 diagram and prompts:**

<Frame>
  <img src="/images/Ov-1_Prompt.png" alt="Davinci prompt showing user request to create parts tree from OV-1 diagram" />
</Frame>
