...
<CardGroup cols={2}>
  <Card title="Clear Requirement IDs" icon="hashtag">
    Use consistent ID schemes (REQ-SYS-001, REQ-PWR-042) that indicate type and system
  </Card>
  
  <Card title="Verification Methods" icon="vial">
    Assign verification methods (Test, Analysis, Inspection, Demo) to every requirement
  </Card>
  
  <Card title="Maintain Traceability" icon="link">
    Create "satisfies" relationships as you develop the design, not as an afterthought
  </Card>
