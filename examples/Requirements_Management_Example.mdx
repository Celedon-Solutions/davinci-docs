...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_makeRequirementsPrompt.png" alt="Prompting Davinci to extract requirements from the Phoenix mission proposal PDF" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_displayRequirements.png" alt="Davinci displays the PDF alongside the extracted requirements organized in the model tree" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_manualRequirementsCreation.png" alt="Creating a requirement manually using the New Object button in Davinci" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_displayRequirementsHierarchy.png" alt="Hierarchical requirement structure showing decomposition from mission to subsystem level" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_linkRequirementsPrompt.png" alt="Prompting Davinci to create relationships between parts and requirements" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_displayRequirementsRelationships.png" alt="Requirement properties showing in/out relationships to system parts and subsystems" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_displayRequirementsTableView.png" alt="Table view showing Phoenix requirements with Name and Documentation columns" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_displayRequirementsDigitalThread.png" alt="Digital thread view showing Battery Configuration Requirement traced to parts and components" />
</Frame>
...
<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_Constraints.png" alt="Requirement with a TBD value expression used for verification" />
</Frame>

*TBD: requirement value or measurement is not yet provided—verification pending*

<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_ConstraintsError.png" alt="Requirement value expression showing Error state when expression is invalid" />
</Frame>

*Error: expression cannot be evaluated (e.g., malformed units or syntax)—fix before verification*

<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_ConstraintsFalse.png" alt="Requirement value expression evaluated to FALSE (does not meet requirement)" />
</Frame>

*FALSE: measured/entered value does not satisfy the requirement—verification failed*

<Frame>
  <img src="/images/examples/requirements_management_example/Requirements_Management_and_Traceability_ConstraintsTrue.png" alt="Requirement value expression evaluated to TRUE (meets requirement)" />
</Frame>
