...
description: "Transform technical documents into structured system models with requirements, parts, and relationships using Davinci in under 15 minutes"
icon: "file-lines"
---
...
<Frame>
  <img src="/images/examples/technical_decomposition_example/Upload_Button.png" alt="Upload button in Davinci chat input area" />
</Frame>

*Upload button in the chat input area - click to attach your technical documents*

<Frame>
  <img src="/images/examples/technical_decomposition_example/Upload_Button_2.png" alt="Alternative upload button location in Davinci" />
</Frame>

*Alternative upload location - upload button in the library section*

<Frame>
  <img src="/images/examples/technical_decomposition_example/Reference_File_Library.png" alt="File library showing uploaded technical documents in Davinci" />
</Frame>

*File library view showing your uploaded documents ready to be referenced in prompts*

<Frame>
  <img src="/images/examples/technical_decomposition_example/PDF_Upload_Example2.png" alt="Phoenix CubeSat proposal PDF uploaded and ready for analysis in Davinci" />
</Frame>
...
<Frame>
  <img src="/images/examples/technical_decomposition_example/Prompt_PartsTree_Example_2.png" alt="Example prompt in Davinci requesting parts tree extraction from Phoenix CubeSat specification" />
</Frame>
...
<Frame>
  <img src="/images/examples/technical_decomposition_example/PartsTree_Output_Example_Two.png" alt="Parts tree output showing CubeSat system hierarchy extracted from Phoenix proposal" />
</Frame>
...
<Frame>
  <img src="/images/examples/technical_decomposition_example/Second_Promt_Example_2.png" alt="Second prompt requesting requirements extraction from Phoenix proposal" />
</Frame>
...
<Frame>
  <img src="/images/examples/technical_decomposition_example/Source_Highlighting_Example_Two.png" alt="Davinci highlighting exact source text from PDF used to create model elements" />
</Frame>
